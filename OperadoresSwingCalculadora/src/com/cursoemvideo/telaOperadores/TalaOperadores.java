 ...
 */
package com.cursoemvideo.telaOperadores;

/**
 *
 * @author Pricilla
 */
public class TalaOperadores extends javax.swing.JFrame {

    /**
     * Creates new form TalaOperadores
     */
    public TalaOperadores() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TalaOperadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TalaOperadores().setVisible(true);
            }
        });
    }
